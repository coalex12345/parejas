...
class Calculadora
{
    ...
    la lista de argumentos que se pasan al programa  */
		...
		try
		{
			//comprobamos que el numero de argumentos no son validos
			if(arg.length != 3) {
		...
		// Errores no verificables que se van a controlar
		...
		catch(ArithmeticException error)
			{
				...
				System.out.println("el numero de elementos no esta bien brother");	
		}
...
class ErrorArgumentos extends Exeption {
